...
<div class="flex justify-center mt-10">
    <h1 class="box-decoration-slice bg-gradient-to-r from-indigo-600 to-pink-500 text-white p-2 rounded-lg text-light font-semibold text-2xl">Selamat Datang</h1>
</div>
    ...
    <form action="" method="POST" class="w-96 mx-auto border-4 shadow-slate-500 shadow-xl border-cyan-500 rounded-xl p-4 bg-white rounded-xl mt-3 mb-16">
        ...
        <div class="text-center mt-2 font-semibold">
            <h1>
                ...
                <a href="/register" class="underline text-blue-400 underline-offset-4 duration-300">Klik Disini</a>
            </h1>
        </div>
    </form>
